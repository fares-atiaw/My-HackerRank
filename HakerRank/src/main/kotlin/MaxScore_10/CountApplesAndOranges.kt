...
fun countApplesAndOranges(s: Int, t: Int, a: Int, b: Int, apples: Array<Int>, oranges: Array<Int>): Unit {
    val arrivedApples = apples.count {  it+a in s..t }
    val arrivedOranges = oranges.count { it+b in s..t }

//    println("Arrived apples : $arrivedApples\nArrived oranges : $arrivedOranges")
    println(arrivedApples)
    println(arrivedOranges)
}
